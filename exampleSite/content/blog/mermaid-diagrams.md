...
<!-- prettier-ignore -->
{{< mermaid title="Flowchart: Decision Process" >}}
graph TD
...
<!-- prettier-ignore -->
{{< mermaid title="Sequence Diagram: API Call" >}}
sequenceDiagram
    participant User
    participant Browser
    participant Server
...
<!-- prettier-ignore -->
{{< mermaid title="Class Diagram: Data Model" >}}
classDiagram
    class Animal {
        +String name
        +int age
...
<!-- prettier-ignore -->
{{< mermaid title="State Diagram: Order Process" >}}
stateDiagram-v2
    [*] --> Pending
...
<!-- prettier-ignore -->
{{< mermaid title="Gantt Chart: Project Plan" >}}
gantt
